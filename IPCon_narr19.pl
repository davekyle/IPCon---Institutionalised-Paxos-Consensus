%% Narrative to show loss of multiple agents and agent neutral obligation instantiation to revise
verbose :-
 false.
...
%%Make a leader
initially( role_of(ag2, leader, any, issue, cluster) = true ).
...
happens( arrogateLeadership( ag1,					issue,	cluster ),	3). 
