...
% we assume that ag5 is happy to leave ag1 as leader
...
happens( prepare1a( ag1, (1,3), 						issue,	cluster ),	12).
happens( response1b(ag1, ( ag1, (1,0),null ), 	(1,3),	issue,	cluster ), 	13).
happens( response1b(ag2, ( ag2, (1,1),a ),	 	(1,3),	issue,	cluster ), 	13).
happens( response1b(ag3, ( ag3, (1,1),a ), 		(1,3),	issue,	cluster ), 	13).
happens( response1b(ag4, ( ag4, (1,0),null ), 	(1,3),	issue,	cluster ), 	13).
happens( response1b(ag5, ( ag5, (1,0),null ), 	(1,3),	issue,	cluster ), 	13).
happens( response1b(ag6, ( ag6, (1,0),null ), 	(1,3),	issue,	cluster ), 	13).
happens( response1b(ag7, ( ag7, (1,0),null ),	(1,3),	issue,	cluster ), 	13).
happens( response1b(ag8, ( ag8, (1,0),null ), 	(1,3),	issue,	cluster ), 	13).
happens( submit2a(	ag1, (1,3), c,						issue,	cluster ),	14).
happens( vote2b( 	ag1, (1,3), c,						issue,	cluster ),	15).
happens( vote2b( 	ag3, (1,3), c,						issue,	cluster ),	15).
happens( vote2b( 	ag4, (1,3), c,						issue,	cluster ),	15).
happens( vote2b( 	ag5, (1,3), c,						issue,	cluster ),	15).
happens( vote2b( 	ag8, (1,3), c,						issue,	cluster ),	15).
%% chosen
